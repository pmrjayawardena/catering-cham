        ...
        <div class="row">
          ...
          <div class="col-lg-6 pl-2 pl-lg-5">
            ...
            <div class="col-md-8 mx-auto contact-form-contact-info">
              <h4 class="mb-5">College Contact Details</h4>
                <p class="d-flex">
                  <span class="ion-ios-location icon mr-5"></span>
                  <span>Aquinas University College,<br> 34/127 Maradana Road,Colombo</span>
                </p>

                <p class="d-flex">
                  <span class="ion-ios-telephone icon mr-5"></span>
                  <span>+94 112 846 994</span>
                </p>
          ...
          <div class="col-lg-7">
            <div class="owl-carousel centernonloop2">
                ...
                <blockquote class="testimonial">
                  ...
                  <div class="d-flex author">
                    ...
                    <div class="author-info">
                      <h4>Maleesha Aththanayke</h4>
                      <p>English Teacher, Aquinas University College</p>
                    </div>
                  </div>  
                </blockquote>
              </div>
              <div class="slide" data-aos="fade-left" data-aos-delay="200">
                <blockquote class="testimonial">
                  <p>&ldquo; Avoiding unnecessary packaging and wrapping is soo good,This is not only reduce the costnof products but also helpsthe environment. &rdquo;</p>
                  <div class="d-flex author">
                    <img src="img/person_2.jpg" alt="" class="mr-4">
                    <div class="author-info">
                      <h4>Rajitha Dikkubura</h4>
                      <p>Vice Chanceller, Aquinas University College</p>
                    </div>
                  </div>  
                </blockquote>
              </div>
                ...
                <blockquote class="testimonial">
                  ...
                  <div class="d-flex author">
                    ...
                    <div class="author-info">
                      ...
                      <p>Teacher in Charge, Hospitality Management Department,Aquinas University College</p>
                    </div>
                  </div>  
                </blockquote>
              </div>
          ...
          <div class="col-md-5 mb-5">
            ...
            <div>
              ...
              <ul class="list-unstyled footer-link">
                ...
                <li class="d-block"><span class="d-block text-black">Email:</span><span>cdchamihundred@gmail.com</span></li>
              </ul>
            </div>
          </div>
