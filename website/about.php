  ...
  <body>
    ...
    <header role="banner">
      <nav class="navbar navbar-expand-md navbar-dark bg-dark">
        <div class="container">
          <a class="navbar-brand" href="index.php">Healthy foods healthy learning</a>
        ...
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-md-8 text-center col-sm-12 ">
              <h1 data-aos="fade-up">About the Canteen</h1>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-5 ml-auto">
            ...
            <p>The school canteen is a small business.Like any business,it requires good manageent practices to be efficient and successful.<br>The purchase of goods is a significant canteen expense and therefore it is critical that this process is organized and efficeient.It is important to buy products at the best price,buy appropriate quantities,ensure safe,high-quality products,order at the appropriate time.</p>
          ...
          <div class="col-md-5 mb-5">
            ...
            <div>
              ...
              <ul class="list-unstyled footer-link">
                ...
                <li class="d-block"><span class="d-block text-black">Email:</span><span>cdhundred@gmai.com</span></li>
              </ul>
            </div>
          </div>
