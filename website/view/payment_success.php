...
if($_SESSION["paypalphp"]==""){
    ...
    <script type="text/javascript">
        window.location="../view/cashondelivery.php";
    </script>
    <?php  }else{
...
$payment_type="PayPal";
$obpayment->addPayment1($pay,$deliverycharge,$order_id,$transaction_id,$dis,$payment_type);
...
// }else{
//     $obpayment->addPayment($pay,$deliverycharge,$order_id,$transaction_id,$dis,$payment_type);
