...
<section class="banner_area">
    <div class="container">
        <div class="banner_content">
            <h4>FEEDBACK</h4>
            <a href="#">Home</a>
            <a class="active" href="../view/item_feedback.php">Item Feedback</a>
        </div>
    </div>
</section>
<!--================End Banner Area =================-->
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
             Rs .<?php echo $rowitem['item_price']; ?>.00
         </div>
     </div>
             <div class="clearfix">&nbsp;</div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
             <?php echo $rowitem['suitable_for']; ?> People
         </div>
     </div>
     <div class="clearfix">&nbsp;</div>
     <div class="row">
...
<a href="../view/items.php">
 ...
 <div class="clearfix">&nbsp;</div>
<a href="../view/addafeedback.php?item_id=<?php echo $rowitem['item_id']; ?>">
      <input type="button" value="Add a Feedback" onclic class="btn btn-primary btn-lg btn-block" />
  </a>
 <div class="clearfix">&nbsp;</div>
 <div class="clearfix">&nbsp;</div>
...
<div id="carousel-example" class="carousel slide hidden-xs" data-ride="carousel" data-type="multi">
    <div class="carousel-inner">
        <div class="item active">
           ...
           $resultf=$obfeedback->viewallFeedbackitem($item_id);
           $result = $resultf->fetchAll();
           foreach($result as $row)
           {
$cus_id=$row['cus_id'];

$resultcus=$obc->viewACustomerinordering($cus_id);
...
$rowcus=$resultcus->fetch(PDO::FETCH_BOTH);
            ...
            if($rowcus['cus_image']==""){
              ...
              $cimage="../img/cus_images/".$rowcus['cus_image'];
            }
      ?>
<article class="row">
      ...
      <div class="col-md-2 col-sm-2 col-md-offset-1 col-sm-offset-0 hidden-xs">
          <figure class="thumbnail">
            <img class="img-responsive" src="<?php echo $cimage; ?>" width="80px" height="100px" />
      ...
      <div class="panel panel-default arrow left">
        ...
        <div class="panel-body">
          <header class="text-left">
            <div class="comment-user"><i class="fa fa-user"></i> Customer Name: <?php echo $rowcus['cus_fname']." ".$rowcus['cus_lname']?></div><br>
