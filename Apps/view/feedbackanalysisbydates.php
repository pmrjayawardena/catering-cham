...
<div class="page-wrapper">
  ...
  <div class="row page-titles">
    ...
    <div class="col-lg-12 align-self-center">
     <img src="../images/feedback.png" alt="homepage" class="dark-logo" width="200px" height="100px" align="center" />&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span> Feedback Analysis</span>
     <ol class="breadcrumb">
  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        <div class="card-body">
          ...
          <?php if($nor==0){
            ...
            <div id="section-to-print">
              <h3 align="center">Feedback Analysis Report</h3><br>
              <table class="table">
                <tr>
                  <td>Feedback Date</td>
                  <td>Count</td>
                ...
                <?php while($rowresa=$result1->fetch(PDO::FETCH_BOTH)){
                  ...
                  <tr>
                    ...
                    <td><?php echo $rowresa['feedback_date']; ?> </td>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <a href="../view/feedbackanalysisbydatespdf.php?from=<?php echo $f; ?>&to=<?php echo $t; ?>" target="blank">
