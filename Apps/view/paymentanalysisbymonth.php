...
$j= sprintf("%02d",$m); //limit to two numbers d means decimal and asigned to i //if you get 1 the sprint f will be 01

$pat=$y."-".$j;   //year - month

$result3=$obj->paymentAnalysisByDatemonth($pat);

$arr=array("january","February","March","April","May","June","July","Auguest","September","October","November","December");



$nor=$result3->rowCount();
            ...
            <div id="section-to-print">
              <table class="table">
                ...
                <?php while($rowres=$result3->fetch(PDO::FETCH_BOTH)){
                  ...
                  <?php if($rowres['payment_status']!=""){?>
                  <tr class="alert alert-success">
                    
                    <td><?php echo $rowres['ct']; ?></td>
                    <td><?php echo $arr[$m-1]; ?> </td>
                    <td>Rs <?php echo $rowres['S']; ?> </td>
                  </tr>

                <?php }else{?>
<tr><?php echo  "<div class='alert alert-danger'>No records</div>"?></tr>
