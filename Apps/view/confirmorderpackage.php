...
<form method="post" action="../controller/ordercontroller.php?action=selectpackage&order_id=<?php echo $order_id ?>&cus_id=<?php echo $cus_id ?>" enctype="multipart/form-data">
