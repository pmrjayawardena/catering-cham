          ...
          <div class="card">
            <div class="card-body">
             ...
             <div class="card-body m-t-15">
              <form method="post" action="../controller/offercontroller.php?action=add" enctype="multipart/form-data" name="RegForm" onsubmit="return GEEKFORGEEKS()">
              ...
              <div class="row" >
               ...
               <div class="col-md-2">
                 <input type="number" id="check_amount" name="check_amount" class="form-control">
