...
<div class="page-wrapper">
  ...
  <div class="row page-titles">
    ...
    <div class="col-lg-12 align-self-center">
     <img src="../images/tracking.jpg" alt="homepage" class="dark-logo" width="200px" height="100px" align="center" />&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span> USER TRACKING</span>
     <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="../view/dashboard.php">Home</a></li>
      <li class="breadcrumb-item"><a href="../view/dashboard.php">Dashboard</a></li>
      <li class="breadcrumb-item active">User Trackimg</li>
    </ol>
  </div>
              ...
              <tbody>
               ...
               while ($row = $result->fetch(PDO::FETCH_BOTH)) {
                            ...
                            <tr>
                             ...
                             <td style="height:55px"><?php echo $row['user_id']; ?> </td>

                             <td style="height:55px"><?php echo $row['user_fname'] . " " . $row['user_lname']; ?></td>
