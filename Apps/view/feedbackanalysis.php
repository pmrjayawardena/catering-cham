      ...
      <div class="card">
        <div class="card-body">
          <div>
           ...
           <!-- Start Page Content -->
           <form action="../view/feedbackanalysisbydates.php" method="post">
            <div class="row">
              <div class="col-md-4">
                From: <input type="date" name="from" class="form-control"  required onchange="getFrom(this.value);"/>
              </div>
              <div class="col-md-4">
                To:<span id="showTo"> <input type="date" name="to" class="form-control"  required min="2016-09-19"/></span>
              </div>
          ...
          <hr>
          <form action="feedbackanalysisbyyear.php">
            <div class="row">
              <div class="col-md-4">
                <h4> Year :
              ...
              <div class="col-md-4">
                <h4> (No of Feedbacks per Year) </h4>
              </div>
              
              <input type="submit" class="btn btn-info btn-sm" name="Generate" value="Generate"</h4>
