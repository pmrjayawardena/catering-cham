...
$resultnot = $obn->viewANotification($notification_id);
...
<div class="page-wrapper">
  ...
  <div class="row page-titles">
    <div class="col-md-5 align-self-center">
      <h3 class="text-primary">VIEW ALL NOTIFICATIONS</h3> </div>
      <div class="col-md-7 align-self-center">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">View All Notifications</li>
        </ol>
      </div>
    </div>
    <!-- End Bread crumb -->
    ...
    <div class="container-fluid">
      ...
      <div id="contents">
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
             <p align="center"><img src="../images/notificationview.png" width="200px" height="200px"></p>
             <div class="col-md-6">
              &nbsp;
          ...
          <div class="clearfix" >&nbsp;</div>
          <div class="row">
            <div class="col-md-6" align="center">Notification Message</div>
            <div class="col-md-6">
