      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            ...
            <h3>ADD NOTIFICATIONS TO USERS</h3>
            <div class="clearfix">&nbsp;</div>
            <div class="clearfix">&nbsp;</div>
            <form method="post" action="../controller/notificationcontroller.php?action=add" enctype="multipart/form-data"  name="form" id="form">
                ...
                <div class="col-md-3">
                  <select name="role_id" id="role_id"  class="form-control form-control-lg">
                    ...
                    <?php while($rowd=$r->fetch(PDO::FETCH_BOTH)){?>
                      <option value="<?php echo $rowd['role_id'];?>"> <?php echo $rowd['role_name']; ?>
                    </option>
                  <?php } ?>
                </select>
