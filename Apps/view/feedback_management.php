...
if(isset($_GET['msg'])){
  ...
  if($message==9)
    ...
    echo "<script type='text/javascript'>iziToast.warning({
      title: 'Deleted!',
      message: 'Feedback ID $feedback_id Deleted',
    });</script>";
  }
...
<div class="page-wrapper">
  ...
  <div class="row page-titles">
    ...
    <div class="col-lg-12 align-self-center">
      <img src="../images/feedbackstars.gif" alt="homepage" class="dark-logo" width="200px" height="100px" align="center" />&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span> FEEDBACK MANAGEMENT</span>
      <ol class="breadcrumb">
            ...
            <table id="example231" class="table table-hover" cellspacing="0" width="100%"">
             ...
             <tbody>
               ...
               while ($rownot=$result->fetch(PDO::FETCH_BOTH)) {
                ...
                <tr>
                  <td></td>
                  <td><?php echo $rownot['feedback_id']; ?></td>
                  <td><?php echo $rownot['feedback_title']; ?></td>

                  <td><?php echo $rownot['feedback_rating']; ?></td>
                  <td><?php echo $rownot['item_name']; ?></td>


                  <td>
                    <a href="../view/viewfeedback.php?feedback_id=<?php echo $rownot['feedback_id']; ?>&item_id=<?php echo $rownot['item_id']; ?>"><button type="button" class="btn btn-secondary">View Feedback</button>

                      <a href="../../website/controller/feedbackcontroller.php?feedback_id=<?php echo $rownot['feedback_id'];?>&action=Delete">
                        <button type="button" class="btn btn-danger"  onclick="return confirmation('Delete','A Feedback')">
                          Delete
                        </button>
...
<script type="text/javascript">
  ...
  function confirmation (str) {
    ...
    var r=confirm("Do you want to" +str+ "Feedback ?");
