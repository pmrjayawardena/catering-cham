...
class category{
    ...
    function displayAllCategoryExceptmiscellaneous(){
       ...
       public function addCategory($arr) {
        ...
        $r=$con->prepare("INSERT INTO category (cat_name,cat_des,cat_status) VALUES (?,?,?)");
        $r->execute(array($arr['cat_name'],$arr['cat_des'],"Active"));
    ...
    public function  updateCategory($arr,$cat_id){
        ...
        $r->execute(array($arr['cat_name'],$arr['cat_des'],$cat_id));
