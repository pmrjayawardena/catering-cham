...
class user{
    ...
    public function addUser($arr) {
        ...
        $r->execute(array($arr['user_fname'],$arr['user_lname'],$arr['user_dob'],$arr['user_gender'],$arr['role_id'],$arr['user_tel'],$arr['user_nic'],$arr['dis_id'],$arr['user_add'],"Active"));
        ...
        $r->execute(array($arr['user_fname'],$arr['user_lname'],$arr['user_dob'],$arr['user_gender'],$arr['role_id'],$arr['user_tel'],$arr['user_nic'],$arr['dis_id'],$arr['user_add'],$user_id));
