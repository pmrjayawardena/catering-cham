...
switch ($action) {
    case "add":
        ...
        if ($user_id) { //If user has been added then
            ...
            header("Location:../view/user_management.php?msg1=$msg1"); //redirection if the user added
        } else {
            $msg2 = base64_encode("A record has $msg been added");
            header("Location:../view/adduser.php?msg2=$msg2"); //redirection is the process failed
        }
    ...
    case "update": //update a perticular user
        ...
        header("Location:../view/updateuser.php?user_id=$user_id"); //redirection
        break;
