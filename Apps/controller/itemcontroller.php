...
if($result)
         ...
         header("Location:../view/updateitem.php?item_id=$item_id&msg=4"); //redirection
      break;
...
header("Location:../view/item_management.php?msg=6&item_id=$item_id"); //redirection
...
$msg= base64_encode($msg);
        header("Location:../view/item_management.php?msg=$msg");  //redirection
break;
